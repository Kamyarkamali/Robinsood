...
const EVEN_BG = "bg-gray-100 dark:bg-[#12121e]";

const ODD_BG = "bg-gray-200/60 dark:bg-[#1a1a2e]";

const SECTION_HEADER =
  "px-4 py-2 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-[#12121e]";
...
export default function TradingStatsTable() {
  ...
  return (
    <div dir="rtl" className="p-2 sm:p-4">
      <div className="w-full rounded-md overflow-hidden border border-gray-300 dark:border-gray-700">
        <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr_1fr]">
          <div className="border-b md:border-b-0 md:border-l border-gray-200 dark:border-gray-700">
            <div className={SECTION_HEADER}>
              <span className={`text-sm font-bold text-gray-700 ${TEXT_MAIN}`}>
          ...
          <div>
            <div className={SECTION_HEADER}>
              <span className={`text-sm font-bold ${TEXT_MAIN}`}>
