...
function ProfitFactorCard() {
  return (
    <CardShell className="flex items-center justify-center h-full rounded-[24.14px] border-4 dark:border-[#303030] border-gray-400">
      <div className="flex flex-col gap-3 items-start justify-between">
        ...
        <span
          ...
          className=" text-3xl sm:text-4xl font-bold text-[32px] sm:text-[44px] lg:text-[40px]
